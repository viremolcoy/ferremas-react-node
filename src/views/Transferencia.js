      ...
      <div className="border-t border-gray-200 pt-6">
        <dl className="divide-y divide-gray-200">
          ...
          <div className="py-4 flex justify-between">
            ...
            <dd className="text-sm text-gray-700">$10.000</dd>
          </div>
        </dl>
      </div>
                  ...
                  <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    ...
                    <div className="mt-2">
                      <p className="text-sm text-gray-500">
                        {isCancelled
                          ? 'Su compra será cancelada, si quiere proceder presione el botón "Ok". Si tiene alguna pregunta, póngase en contacto con nuestro servicio de atención al cliente.'
                          : isTimedOut
                          ? 'Lo sentimos, su compra ha sido anulada por término de tiempo.'
                          : 'Hemos recibido tu pedido. Te informaremos cuando se acepte tu información entregada.'}
                      </p>
                    </div>
                  </div>
                </div>
              ...
              {!isTimedOut && (
                <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                  <button
                    ...
                    className={`w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-${isReceived ? 'green' : 'red'}-600 text-base font-medium text-white hover:bg-${isReceived ? 'green' : 'red'}-700 sm:ml-3 sm:w-auto sm:text-sm`}
                  >
                    OK
                  </button>
                  <button
