...
export default function Medicion () {
    ...
    return (
        <div>   
            ...
            <h1 className="text-4xl font-bold tracking-tight text-gray-900 text-center mt-5">Equipos de medición</h1>
      
            <div className="bg-white">
                <div className="mx-auto max-w-2xl px-4 sm:px-6 sm:py-10 lg:max-w-7xl lg:px-8">
                    <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
                        {productos.filter(producto => producto.categoria_id === 6).map((producto) => (
